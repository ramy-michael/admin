                                  ...
                                  <tr class="gradeX">
                                    ...
                                    <td class="text-center actions">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Invoices?id={{$Invoice->id}}" style="font-size: 15px;">تعديل</a></li>
                                            ...
                                            <button type="submit" id="delete-task-{{ $Invoice->id }}"
                                                ...
                                                <li class="text-center" style="margin: 12px;"><a class="btn btn-primary text-center" href="Purchases?id={{$Invoice->id}}" style="font-size: 15px;">استرجاع</a></li>
                                            </li>
                                        </ul>
